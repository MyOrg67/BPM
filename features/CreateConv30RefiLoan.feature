Feature:  Creating a Conventional 30 year Refinance loan in Mortgagebot
  Scenario:  Creating a loan from beginning to disclosure
    ...
    And select refinance for purpose of loan in Borrower Summary
    And select conforming 30yr fixed for product in Borrower Summary
